...
(function(_) {
  ...
  zc = function() {
    if (_.y.Promise && _.y.Promise.resolve) {
      ...
      var b = Ec;
      !_.Ua(_.y.setImmediate) || _.y.Window && _.y.Window.prototype && !_.Jb("Edge") && _.y.Window.prototype.setImmediate == _.y.setImmediate ? (Fc || (Fc = vc()), Fc(b)) : _.y.setImmediate(b)
    }
  };
  Ec = function() {
  ...
  _.ie = function(a, b) {
    ...
    } else this.pa = new he(1, -1), this.ka = new de(180, -180)
  };
  _.je = function(a, b, c, d) {
    return new _.ie(new _.L(a, b, !0), new _.L(c, d, !0))
  };
  _.le = function(a) {
  ...
  _.Kf = function(a, b, c) {
    function d(w) {
      ...
      w = K ? D[K] : w.id;
      if (null != w && !_.sd(w) && !_.ud(w)) throw _.zd((K || "id") + " is not a string or number");
      return {
        id: w,
        geometry: x,
        properties: D
    ...
    function e(w) {
      ...
      try {
        ...
        throw _.zd('in property "coordinates"', K);
      }
      if ("geometrycollection" == x) try {
        return new _.wf(v(w.geometries))
      } catch (K) {
        throw _.zd('in property "geometries"', K);
      }
  ...
  Pf = function(a) {
    a = void 0 === a ? {} : a;
    _.N.ei(this);
    this.element = _.Jd(_.Dd(Element, "Element"))(a.element) || document.createElement("div");
    if (this.constructor === Pf)
      for (var b in a)
  ...
  wg = function(a, b, c, d) {
    for (var e = 0; e < a.length; ++e) {
      var f = a[e];
      if (!f.Tb && f.listener == b && f.capture == !!c && f.lc == d) return e
    }
    return -1
  };
  _.yg = function(a, b, c, d, e) {
    if (d && d.once) return _.xg(a, b, c, d, e);
    if (_.Sa(b)) {
      for (var f = 0; f < b.length; f++) _.yg(a, b[f], c, d, e);
      return null
    }
    c = zg(c);
    return a && a[Ag] ? a.listen(b, c, _.Va(d) ? !!d.capture : !!d, e) : Bg(a, b, c, !1, d, e)
  };
  Bg = function(a, b, c, d, e, f) {
    ...
    d.src = a;
    d.listener = c;
    if (a.addEventListener) Fg || (e = g), void 0 === e && (e = !1), a.addEventListener(b.toString(), d, e);
  ...
  _.xg = function(a, b, c, d, e) {
    if (_.Sa(b)) {
      for (var f = 0; f < b.length; f++) _.xg(a, b[f], c, d, e);
      return null
    }
    c = zg(c);
    return a && a[Ag] ? a.j.add(String(b), c, !0, _.Va(d) ? !!d.capture : !!d, e) : Bg(a, b, c, !0, d, e)
  };
  ...
  Cg = function(a) {
    a = a[Dg];
    return a instanceof ug ? a : null
  };
  zg = function(a) {
    if (_.Ua(a)) return a;
    a[Pg] || (a[Pg] = function(b) {
  ...
  bh = function(a, b, c, d) {
    ...
    e.g = new _.Sg(function(f, g) {
      ...
      e.h = c ? function(h) {
        try {
          var k = c.call(d, h);
          void 0 === k && h instanceof ah ? g(h) : f(k)
        } catch (l) {
          g(l)
        }
      } : g
    ...
    if (0 == a.g) {
      ...
      a: {
        var d = c,
          e = a.H,
          f = a.J;
        if (d instanceof _.Sg) {
          $g(d, Vg(e || _.Qa, f || null, a));
          var g = !0
        } else {
          if (d) try {
  ...
  Yg = function(a, b, c, d) {
    ...
    if (b.g) b.g.i = null, eh(b, c, d);
    else try {
      b.j ? b.i.call(b.context) : eh(b, c, d)
    } catch (e) {
      fh.call(null, e)
    }
    mc(Ug, b)
  ...
  _.rh = function(a, b) {
    var c = a.lat() + _.oc(b);
    90 < c && (c = 90);
    var d = a.lat() - _.oc(b); - 90 > d && (d = -90);
    b = Math.sin(b);
    var e = Math.cos(_.nc(a.lat()));
    if (90 == c || -90 == d || 1E-6 > e) return new _.ie(new _.L(d, -180), new _.L(c, 180));
    b = _.oc(Math.asin(b / e));
    return new _.ie(new _.L(d, a.lng() - b), new _.L(c, a.lng() + b))
  };
  vh = function(a, b) {
    var c = this;
    _.Ve.call(this);
    ...
    _.uh[35] && b && b.dE && _.P("util").then(function(f) {
      f.g.j(new _.hd(b.dE))
    })
  };
  wh = function() {
  ...
  _.Ah = function() {
    ...
    b && Array.isArray(b) && _.uh[15] && b.forEach(function(c) {
      _.sd(c) && a.push(c)
    });
    return a
  };
  ...
  Uh = function(a, b, c, d, e) {
    ...
    c.m[0] = b.fa - b.$;
    c.m[1] = b.ea - b.X;
    var h = new Ch(_.G(f, 4));
    h.m[0] = d;
    Dh(h);
    Eh(h);
    h.m[9] = !0;
    _.Ah().forEach(function(k) {
      for (var l = !1, m = 0, q = _.$c(h, 13); m < q; m++)
        if (_.Yc(h, 13, m) === k) {
          l = !0;
          break
        }
    ...
    f = a.J + unescape("%3F") + Nh(f);
    return a.H(f)
  };
  Vh = function(a, b) {
    var c = a.h;
    b != c.src ? (a.i || _.Sh(c), c.onload = function() {
      Yh(a, !0)
    }, c.onerror = function() {
      Yh(a, !1)
  ...
  _.$h = function(a) {
    for (var b; b = a.firstChild;) _.Zh(b), a.removeChild(b)
  };
  _.Zh = function(a) {
    a = new mh(a);
    try {
  ...
  ei = function(a, b) {
    ...
    _.P("util").then(function(l) {
      _.uh[35] && b && b.dE && l.g.j(new _.hd(b.dE));
      l.g.g(function(m) {
        _.P("controls").then(function(q) {
          q.gi(a, _.F(m, 1) || "http://g.co/dev/maps-no-account")
        })
      })
    });
  ...
  mi = function(a) {
    return a instanceof _.Me ? ki(a) : new _.Me(li(a))
  };
  oi = function(a) {
    ...
    return b ? a instanceof _.Me ? ni(ki)(a) : new _.Me(_.Fd(mi)(a)) : new _.Me([mi(a)])
  };
  ni = function(a) {
    return function(b) {
  ...
  _.yi = function() {
    _.yi.kf(this, "constructor")
  };
  _.zi = function(a, b) {
    _.zi.kf(this, "constructor");
    this.set("styles", a);
    a = b || {};
  ...
  Ei = function() {
    ...
    for (var b = 1; 8 > b; ++b) {
      ...
      if (-1 != a.indexOf(c)) {
        ...
        d && (this.version = new Bi(parseInt(d[1], 10), parseInt(d[2] || "0", 10)));
        break
      }
    }
  ...
  _.Ki = function(a, b, c) {
    c = void 0 === c ? "" : c;
    _.Ji && _.P("stats").then(function(d) {
      d.ga(a).F(b + c)
    })
  };
  Li = _.oa("g");
  ...
  Ri = function() {
    function a(c, d) {
      setTimeout(_.Ki, 0, window, c, void 0 === d ? "" : d)
    }
  ...
  _.cj = function(a, b) {
    ...
    if (!(a instanceof _.L || a instanceof _.ie || a instanceof _.pi)) try {
      a = _.le(a)
    } catch (c) {
      try {
        a = _.be(a)
  ...
  Ha("Promise", function(a) {
    ...
    b.race = function(g) {
      return new b(function(h, k) {
        for (var l = _.Ca(g), m = l.next(); !m.done; m = l.next()) d(m.value).Zd(h, k)
      })
    };
    b.all = function(g) {
      var h = _.Ca(g),
  ...
  Ha("Map", function(a) {
    ...
    e.prototype.set = function(h, k) {
      ...
      l.fb ? l.fb.value = k : (l.fb = {
        ...
        key: h,
        value: k
      }, l.list.push(l.fb), this.g.ec.next = l.fb, this.g.ec = l.fb, this.size++);
      return this
    };
  ...
  a: {
    var xj = "",
      yj = function() {
        var a = _.zb;
        if (_.ng) return /rv:([^\);]+)(\)|;)/.exec(a);
        if (_.oj) return /Edge\/([\d\.]+)/.exec(a);
        if (_.nj) return /\b(?:MSIE|rv)[: ]([^\);]+)(\)|;)/.exec(a);
        if (_.og) return /WebKit\/(\S+)/.exec(a);
        if (_.mj) return /(?:Version)[ \/]?(\S+)/.exec(a)
      }();yj && (xj = yj ? yj[1] : "");
    if (_.nj) {
      var zj = ac();
  ...
  _.Kc.prototype.equals = function(a) {
    return this === a ? !0 : a instanceof _.Kc ? this.h === a.h && this.g === a.g : !1
  };
  _.dk = new _.Kc(0, 0);
  _.Qc.prototype.forEach = function(a, b) {
    for (var c = {
      ...
      c.Ec++;
      g == e && (c.Ec = this.i[f++], e = this.i[f++], g += Math.ceil(Math.log10(c.Ec + 1)));
  ...
  _.ie.prototype.getCenter = function() {
    return new _.L(this.pa.center(), this.ka.center())
  };
  ...
  _.Se.prototype.set = function(a) {
    this.l && this.get() === a || (this.Jh(a), this.notify())
  };
  _.A(_.Te, _.Se);
  ...
  Xe.prototype.set = function(a, b) {
    if (null != b && !(b && _.sd(b.maxZoom) && b.tileSize && b.tileSize.width && b.tileSize.height && b.getTile && b.getTile.apply)) throw Error("Wert zur Implementierung von google.maps.MapType erwartet");
  ...
  */
    ...
    if (!this.g[a]) {
      ...
      mf(c.i, function(e) {
        for (var f = e.g[a] || [], g = e.j[a] || [], h = d[a] = pf(f.length, function() {
            delete d[a];
            b(e.h);
            for (var m = c.h[a], q = m ? m.length : 0, r = 0; r < q; ++r) m[r].Cb(c.g[a]);
            delete c.h[a];
            r = 0;
  ...
  _.Ke(Mf.prototype, {
    map: _.vk,
    style: _.mb,
    controls: _.Jd(_.Fd(_.Ed(tk))),
    controlPosition: _.Jd(_.Ed(_.th)),
    drawingMode: _.Jd(_.Ed(tk))
  });
  _.wk = {
    METRIC: 0,
    IMPERIAL: 1
  ...
  _.Ga(_.Tf, Pf);
  _.Tf.prototype.getAnchor = function() {
    return new _.I(0, 0)
  };
  ...
  _.Ke(Uf.prototype, {
    position: _.Jd(_.be),
    title: _.lk,
    icon: _.Jd(_.Hd([_.ik, _.Dd(_.Tf, "PinView"), {
      tg: Kd("url"),
      then: _.Bd({
        url: _.ik,
        scaledSize: _.Jd(Nd),
  ...
  _.t.internalAnchorPoint_changed = Wf.prototype.internalPixelOffset_changed = function() {
    var a = this.get("internalAnchorPoint") || _.nk,
  ...
  _.t.internalContent_changed = function() {
    this.set("content", Qf(this.get("internalContent")))
  };
  ...
  _.Yf.prototype.open = function(a, b) {
    this.set("anchor", b);
    b ? !this.get("map") && a && this.set("map", a) : this.set("map", a)
  };
  _.Yf.prototype.open = _.Yf.prototype.open;
  _.Yf.prototype.close = function() {
    this.set("map", null)
  };
  ...
  bg.prototype.route = function(a, b) {
  ...
  _.hg.prototype.fromPointToLatLng = function(a, b) {
    var c = this.j;
    return new _.L(_.oc(2 * Math.atan(Math.exp((a.y - c.y) / -this.i)) - Math.PI / 2), (a.x - c.x) / this.g, void 0 === b ? !1 : b)
  };
  _.Kk = Math.sqrt(2);
  _.Lk = new _.hg;
  _.A(_.ig, _.O);
  ...
  var Ag = "closure_listenable_" + (1E6 * Math.random() | 0),
    rg = 0;
  ug.prototype.add = function(a, b, c, d, e) {
    var f = a.toString();
    a = this.listeners[f];
    a || (a = this.listeners[f] = [], this.g++);
    var g = wg(a, b, d, e); - 1 < g ? (b = a[g], c || (b.Yd = !1)) : (b = new sg(b, this.src, f, !!d, e), b.Yd = c, a.push(b));
    return b
  };
  ug.prototype.remove = function(a, b, c, d) {
    a = a.toString();
    if (!(a in this.listeners)) return !1;
    var e = this.listeners[a];
    b = wg(e, b, c, d);
    return -1 < b ? (tg(e[b]), _.jb(e, b), 0 == e.length && (delete this.listeners[a], this.g--), !0) : !1
  };
  ...
  _.A(_.Qg, _.lg);
  _.Qg.prototype[Ag] = !0;
  _.Qg.prototype.addEventListener = function(a, b, c, d) {
    _.yg(this, a, b, c, d)
  };
  _.Qg.prototype.removeEventListener = function(a, b, c, d) {
    Kg(this, a, b, c, d)
  };
  _.Qg.prototype.vb = function() {
    _.Qg.Gb.vb.call(this);
    if (this.j) {
      var a = this.j,
        b = 0,
        c;
      for (c in a.listeners) {
        for (var d = a.listeners[c], e = 0; e < d.length; e++) ++b, tg(d[e]);
  ...
  _.Qg.prototype.listen = function(a, b, c, d) {
  ...
  var Ug = new lc(function() {
    return new Tg
  }, function(a) {
    a.reset()
  });
  _.Sg.prototype.then = function(a, b, c) {
    return bh(this, _.Ua(a) ? a : null, _.Ua(b) ? b : null, c)
  };
  ...
  _.Sg.prototype.H = function(a) {
    this.g = 0;
    Rg(this, 2, a)
  };
  _.Sg.prototype.J = function(a) {
    this.g = 0;
    Rg(this, 3, a)
  };
  _.Sg.prototype.F = function() {
    for (var a; a = Xg(this);) Yg(this, a, this.g, this.C);
    this.o = !1
  };
  var fh = tc;
  _.A(ah, _.cb);
  ...
  _.t.stop = function() {
    0 != this.kc && _.y.clearTimeout(this.kc);
    this.kc = 0
  };
  _.t.Ra = function() {
    this.stop();
  ...
  var ai = "StopIteration" in _.y ? _.y.StopIteration : {
  ...
  _.A(lh, kh);
  lh.prototype.setPosition = function(a, b, c) {
  ...
  lh.prototype.next = function() {
    if (this.i) {
      if (!this.node || this.j && 0 == this.depth) throw ai;
      var a = this.node;
      var b = this.g ? -1 : 1;
      if (this.h == b) {
  ...
  lh.prototype.splice = function(a) {
    ...
    for (var d = c.length - 1; 0 <= d; d--) _.rc(c[d], b);
    _.sc(b)
  };
  _.A(mh, lh);
  mh.prototype.next = function() {
    do mh.Gb.next.call(this); while (-1 == this.h);
    return this.node
  };
  _.Nk = !!(_.y.requestAnimationFrame && _.y.performance && _.y.performance.now);
  _.Ok = new WeakMap;
  _.ph.prototype.equals = function(a) {
    return this == a || a instanceof _.ph && this.size.K == a.size.K && this.size.T == a.size.T && this.heading == a.heading && this.tilt == a.tilt
  };
  _.Pk = new _.ph({
    K: 256,
    T: 256
  ...
  wh.prototype.register = function(a) {
    var b = this.j;
    var c = b.length;
  ...
  _.t.changed = function() {
    var a = this.th(),
      ...
      c = Rh(this),
      d = !!this.cf();
    if (a && !a.equals(this.C) || this.R != b || this.ga != c || this.l != d) this.i || _.Sh(this.h), _.jh(this.Z), this.R = b, this.ga = c, this.l = d;
    this.C = a
  };
  ...
  _.A(ei, _.Ye);
  Object.freeze({
    latLngBounds: new _.ie(new _.L(-85, -180), new _.L(85, 180)),
    strictBounds: !0
  });
  ...
  ei.prototype.panBy = function(a, b) {
    var c = this.__gm;
    di ? _.N.trigger(c, "panby", a, b) : _.P("map").then(function() {
  ...
  ei.prototype.panTo = function(a) {
    var b = this.__gm;
    a = ce(a);
    di ? _.N.trigger(b, "panto", a) : _.P("map").then(function() {
  ...
  ei.prototype.panToBounds = function(a, b) {
    var c = this.__gm,
      d = _.le(a);
    di ? _.N.trigger(c, "pantolatlngbounds", d, b) : _.P("map").then(function() {
  ...
  ei.prototype.fitBounds = function(a, b) {
    var c = this,
      d = _.le(a);
    di ? di.fitBounds(this, d, b) : _.P("map").then(function(e) {
      e.fitBounds(c, d, b)
    })
  };
  ...
  _.Ke(ei.prototype, {
    ...
    restriction: function(a) {
      ...
      if (!(b.pa.h > b.pa.g)) throw _.zd("south latitude must be smaller than north latitude");
  ...
  fi.prototype.getMaxZoomAtLatLng = function(a, b) {
  ...
  _.Ke(gi.prototype, {
    map: _.vk,
    tableId: _.kk,
    query: _.Jd(_.Hd([_.ik, _.Gd(_.td, "not an Object")]))
  });
  var Tk = null;
  _.A(_.hi, _.O);
  _.hi.prototype.map_changed = function() {
    var a = this;
    Tk ? Tk.Ig(this) : _.P("overlay").then(function(b) {
      Tk = b;
      b.Ig(a)
    })
  };
  _.hi.preventMapHitsFrom = function(a) {
  ...
  _.hi.preventMapHitsAndGesturesFrom = function(a) {
    _.P("overlay").then(function(b) {
      Tk = b;
  ...
  _.vi.prototype.getPanorama = function(a, b) {
    ...
    _.P("streetview").then(function(d) {
      _.P("geometry").then(function(e) {
        d.Zj(a, b, e.computeHeading, e.computeOffset, c)
      })
    })
  };
  ...
  Gi.prototype.h = nb(function() {
    return void 0 !== (new Image).crossOrigin
  });
  Gi.prototype.i = nb(function() {
